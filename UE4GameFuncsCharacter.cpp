...
void AUE4GameFuncsCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AUE4GameFuncsCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AUE4GameFuncsCharacter::MoveRight);
...
void AUE4GameFuncsCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
...
void AUE4GameFuncsCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
...
void AUE4GameFuncsCharacter::MoveRight(float Value)
{
	if ( (Controller != nullptr) && (Value != 0.0f) )
	{
